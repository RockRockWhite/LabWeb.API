...
func InitApiRouter() *gin.Engine {
	...
	paper := router.Group("/papers")
	{
		...
		paper.GET("/years", middlewares.JwtAuth(middlewares.Role_Admin, nil), controllers.GetPaperYears)
		...
		paper.GET("/public/years", controllers.GetPublicPaperYears)
		paper.GET("/highlight/years", controllers.GetHighlightPaperYears)
		paper.GET("/private/years", middlewares.JwtAuth(middlewares.Role_All, nil), controllers.GetPrivatePaperYears)
